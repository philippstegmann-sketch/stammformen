const verbs = [
  ...
  },
  {
    ...
    "hint": "Bei Modalverben mit einem weiteren Infinitiv steht im Perfekt meist der Ersatzinfinitiv: «haben gehen dürfen», nicht «gedurft».",
    "sentencePreterite": "Die Lernenden ___ früher gehen.",
    "sentencePerfect": "Die Lernenden haben früher gehen ___.",
    "secondLabel": "Ersatzinfinitiv im Perfekt",
    "secondShortLabel": "Ersatzinfinitiv"
  },
  {
  ...
  },
  {
    ...
    "sentencePerfect": "Die Pflanzen sind im milden Klima ___.",
    "secondLabel": "Partizip II",
    "secondShortLabel": "Partizip II"
  },
  {
  ...
  },
  {
    ...
    "sentencePerfect": "Sie ist pünktlich zum Termin ___.",
    "secondLabel": "Partizip II",
    "secondShortLabel": "Partizip II"
  },
  {
    ...
    "hint": "Bei Modalverben mit einem weiteren Infinitiv steht im Perfekt der Ersatzinfinitiv: «hat lösen können», nicht «gekonnt».",
  ...
  },
  {
    ...
    "hint": "Hier steht kein weiterer Infinitiv, deshalb ist «gemocht» passend.",
  ...
  },
  {
    ...
    "hint": "Bei Modalverben mit einem weiteren Infinitiv steht im Perfekt der Ersatzinfinitiv: «haben warten müssen», nicht «gemusst».",
  ...
  },
  {
    ...
    "sentencePerfect": "Sie ist über die Wiese ___.",
    "secondLabel": "Partizip II",
    "secondShortLabel": "Partizip II"
  },
  {
  ...
  },
  {
    ...
    "sentencePerfect": "Das Eis ist in der Sonne ___.",
    "secondLabel": "Partizip II",
    "secondShortLabel": "Partizip II"
  },
  {
    ...
    "hint": "Bei «schmelzen» gibt es eine starke intransitive Form («Das Eis ist geschmolzen») und eine transitive Verwendung. Im heutigen Standard ist auch «hat das Metall geschmolzen» sehr üblich; «geschmelzt» wird als schwache Form mitgeübt.",
...
let state = JSON.parse(localStorage.getItem("missionStammformenStateV4")) || {
  score: 0,
  streak: 0,
  totalForms: 0,
  correctForms: 0,
...
function getSecondLabel(task) {
  return task.secondShortLabel || "Partizip II";
}

function renderSentences() {
  const block = $("sentenceBlock");
  const secondLabel = getSecondLabel(currentTask);
  ...
  if (currentMode === "preterite") {
    ...
    block.innerHTML = `<div class="sentenceLine"><strong>Perfekt / ${secondLabel}:</strong> ${markBlank(currentTask.sentencePerfect)}</div>`;
  } else {
    block.innerHTML = `
      <div class="sentenceLine"><strong>Präteritum:</strong> ${markBlank(currentTask.sentencePreterite)}</div>
      <div class="sentenceLine"><strong>Perfekt / ${secondLabel}:</strong> ${markBlank(currentTask.sentencePerfect)}</div>
    `;
  }
}
...
function newTask() {
  ...
  $("participleLabel").textContent = currentTask.secondLabel || "Partizip II";
  $("participleInput").placeholder = currentTask.secondShortLabel === "Ersatzinfinitiv" ? "z. B. können" : "z. B. gebacken";
  renderSentences();
...
function updateStats() {
  ...
  localStorage.setItem("missionStammformenStateV4", JSON.stringify(state));
}
...
function checkAnswer() {
  ...
  if (currentMode === "both" || currentMode === "participle") {
    ...
    if (answer && accepted.includes(answer)) {
      correct += 1;
      details.push(`${secondLabel} richtig`);
    } else {
      details.push(`${secondLabel}: ${formatSolutions(currentTask.participle)}`);
    }
  }
...
$("showSolutionBtn").addEventListener("click", () => {
  ...
  if (currentMode === "both" || currentMode === "participle") {
    parts.push(`${secondLabel}: ${formatSolutions(currentTask.participle)}`);
  }
